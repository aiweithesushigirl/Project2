...
def get_umsi_data():
	...
	params_one = {"field_person_firstname_value":"", "field_person_lastname_value":"", "rid":"All"}
	...
	file = open("html_cache.html", "wb")
	file.write(htmldoc)
	file.close()
	soup = BeautifulSoup(htmldoc,"html.parser")
	for link in soup.find_all('a'):
		print (link)
		for url in link.get('href'):
				url_link.append(url)
	print (type(url_link))
	print (url_link)
